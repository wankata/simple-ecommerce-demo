# Generated by Django 2.1.5 on 2019-01-19 16:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalogue', '0004_category_mptt_model_basic_implementation'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=4, default=Decimal('0.0'), max_digits=13)),
                ('description', models.TextField(blank=True)),
                ('category', mptt.fields.TreeForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogue.Category')),
            ],
        ),
